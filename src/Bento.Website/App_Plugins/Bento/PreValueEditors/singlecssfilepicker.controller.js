function SingleCssFilePickerController($scope, editorService, angularHelper) {
	var vm = this;
	vm.loading = false;
	vm.file = "";
	vm.remove = remove;
...
angular.module('umbraco').controller("Bento.PrevalueEditors.SingleCssFilePickerController", SingleCssFilePickerController);